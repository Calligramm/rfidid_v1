...
function OLED () {
    ...
    3,
    2,
    Zeichenkette.auffuellen("Kommen:" + listKommenZeit[AnzeigeNr], "", 20),
    1
    )
    OLED12864_I2C.showString(
    3,
    3,
    Zeichenkette.auffuellen("Gehen: " + listGehenZeit[AnzeigeNr], " ", 20),
    1
    )
    OLED12864_I2C.showString(
    3,
    ...
    3,
    5,
    Zeichenkette.auffuellen("Gelesene Nummern: " + id_list.length, "", 20),
    1
    )
    OLED12864_I2C.showString(
    3,
